...
$orderid = $_GET['id'];
$liatcust = mysqli_query($koneksi,"select * from pelanggan p, cart c where orderid='$orderid' and p.id_pelanggan=c.id_pelanggan ");
					...
					<div class="mt-0 mb-4">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								...
								<a href="order1.php?id=<?php echo $orderid; ?>">Detail Order</a>
							</li>
									...
									<div class="panel-body">
										<div class="table-responsive">
											<table class="table table-striped table-bordered table-hover" id="dataTables-example">
												...
												<td><img src="../../produk/<?php echo $r['foto_produk'] ?>" width="100px" height="100px" /></a></td>
                                                <td><?= ucwords ($r['qty'] )?></td>
