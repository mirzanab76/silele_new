...
if (isset($_POST['confirm'])) {
    ...
    $veriforder = mysqli_query($koneksi,"select * from cart where orderid='$idorder'");
    ...
    if ($fetc>0) {
        ...
        $kon = mysqli_query($koneksi,"insert into konfirmasi (orderid, id_pelanggan, payment, namarekening, tglbayar) values ('$idorder','$ui','$metode','$nama','$tanggal')");
        if ($kon) {
            $up = mysqli_query($koneksi,"update cart set status='membayar' where orderid='$idorder'");
            echo "<div class='alert alert-success'>
            terima kasih telah melakukan konfirmasi, owner akan melakukan verifikasi.
            </div>
...
<body data-background-color="dark">
	...
	<div class="wrapper">
		...
		<div class="register">
		<div class="container">
			<h2 class="text-white pb-2">Konfirmasi</h2>
			<div class="login-form-grids">
				<h3 class="text-white pb-2">Kode Order</h3>
				<form method="post">
				<strong>
					<input type="text" name="orderid" value="<?php echo $idorder ?>" disabled>
				</strong><br>
                <br>
				<h6 class="text-white pb-2"> Informasi Pembayaran</h6>
					<input type="text" class="form-control" name="nama" placeholder="Nama Pemilik Rekening / Sumber Dana" required>
					<br><br>
					<h6 class="text-white pb-2">Rekening Tujuan</h6>
					<select name="metode" class="form-control">
						
						<?php
						$metode = mysqli_query($koneksi,"select * from metode_bayar");
					...
					<br>
					<h6 class="text-white pb-2">Tanggal Bayar</h6>
					<input type="date" class="form-control" name="tanggal" required="required">
                    <br>
					<input type="submit" class="btn btn-primary" name="confirm" value="Submit"> &emsp;
