			...
			<div class="row">
                <section id ="movies-list">
                        <?php
										...
										<div class="col-md-3">        
											<div class="box">        
											<a href="transaksi/detail_order.php?id_produk=<?php echo $data['id_produk']; ?>">
												<img src="../produk/<?php echo $data['foto_produk'];?>" width="200px" height="200px" />   </a>    
												<div class="desc">            
                                            ...
                                            <div class="d-grid">
                                                ...
                                                <a href="transaksi/detail_order.php?id_produk=<?php echo $data['id_produk']; ?>"><button class="btn " style=" color: DarkSlateBlue;">Lihat Produk</button></a>
                                            </div>
                                        </div>       
										</div>    
										</div>
