		...
		<div class="main-panel">
			<div class="content">
				<div class="page-inner">
					<div class="mt-0 mb-4">
						<h2 class="text-white pb-2">Keranjang</h2>
                        <h4>Dalam keranjangmu ada : <span><?php echo $itungtrans3 ?> barang</span></h4>
					</div>
                                                ...
                                                <tr class="rem1"><form method="post">
                                                    ...
                                                    <td class="invert">
                                                        <div class="rem">
                                                            ...
                                                            <input type="hidden" name="idproduknya" value="<?php echo $b['id_produk'] ?>" \>
														</div>
                                                        </form>
            ...
            <div>	
				...
				<div >
					<a href="bayar.php" class="btn btn-success"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span>Checkout</a>
				</div>
			</div>
		</div>
	</div>
