...
if (isset($_POST["bayar"])) {
    $q3 = mysqli_query($koneksi,"update cart set status='bayar' where orderid='$orderid'");
    if ($q3) {
...
<body data-background-color="dark">
	...
	<div class="wrapper">
		...
		<div class="main-panel">
			<div class="content">
				<div class="page-inner">
					<div class="mt-0 mb-4">
						<h2 class="text-white pb-2">Data Checkout</h2>
                        <div class="page-header">
						<h4 class="page-title active">Checkout</h4>
										...
										<div class="table-responsive">
                                            ...
                                            while($b=mysqli_fetch_array($brg)){
                                                ...
                                                <tr class="rem1"><form method="post">
                                                    <td><?php echo $no++ ?></td>
                                                    <td ><a href="detail_order.php?id_produk=<?php echo $b['id_produk'] ?>">
                                                    <img src="../../produk/<?php echo $b['foto_produk'] ?>" width="100px" height="100px" /></a></td>
            ...
            <div class="checkout-left-basket" style="width:100%;margin-top:20px;">
				...
				<div class="checkout-left-basket" style="width:100%;margin-top:20px;">
					...
					<center><h3><?= $orderid ?></h3></center>
                    <center><h5>Mohon Simpan Bukti Transfer saat melakukan pembayaran</h5></center>
				</div>
				</div>
			...
			<img src="../../metode/<?php echo $p['gambar'];?>" width="100px" height="60px"><br>
        <h4><?php echo $p['metode'] ?> - <?php echo $p['norek'] ?><br>
        a/n. <?php echo $p['atas_nama'] ?></h4><br>
		 <hr>
		...
		<br>
		<form method="post">
		<input type="submit" class="form-control btn btn-success" name="bayar" value="I Agree and Check Out" \>
		</form>
		<br>
