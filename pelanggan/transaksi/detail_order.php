			...
			<div class="content">
				<div class="page-inner">
					<div class="mt-0 mb-4">
						...
						<h4 class="page-title active">Produk</h4>
                        ...
                        <?php
							...
							<li class="nav-item">
								...
								<a href="detail_order.php?id_produk=<?php echo $data['id_produk']; ?>">Produk</a>
							</li>
						</ul>
                        </div>
					</div>
                        ...
                        <div class="row mt-4">
                            <div class="card mb-4">
                                <div class="card-header"><h2>Detail Produk</h2></div>
                                <div class="card-body">
                                    <div class="card mt-4 mb-4">
                                        <div class="row g-0">
                                            <div class="col-md-4">
                                            <img src="../../produk/<?php echo $data['foto_produk'];?>" width="250px" height="300px" class="image-crop img-fluid rounded-start">
                                            </div>
                                        <div class="col-md-8">
                                            <div class="card-body">
                                            <h3 class="card-title mb-2"><?= $data['nama_produk'] ?> </h3>
                                        
                                                <h4 class="mt-4">Deskripsi</h4>
                                                <p class="card-text"><?= $data['deskripsi'] ?></p>
                                                <div class="row">
                                                    <div class="col-sm-6 col-lg-4 col-xxl-3">
                                                    <div class="mb-1"><strong>Stok</strong></div>
                                                    <div class="mb-2"><?= $data['stok'] ?></div>
                                                </div>
                                                <div class="col-sm-6 col-lg-4 col-xxl-3">
                                                    <div class="mb-1"><strong>Harga</strong></div>
                                                    <div class="mb-2"><?= $data['harga'] ?> </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <div class="d-grid">
                                                <!--<a href="proses_tambah.php?id_produk=<?php echo $data['id_produk']?>" class="btn btn-primary"><i class="flaticon-cart"></i>&nbsp; &nbsp; Tambah</a>-->
                                                <input type="submit" name="addprod" class="btn btn-primary" value="+ Tambah"></input>
                                            </div>
                                            </form>
                                        </div>
