                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    	...
                                    	<?php
                                    		...
                                    		//$sql = $koneksi->query ("SELECT * FROM pelanggan WHERE id_pelanggan='$_SESSION[id_pelanggan]' ");
											$sql = $koneksi->query("SELECT * FROM pelanggan INNER JOIN kecamatan ON pelanggan.isi_kecamatan=kecamatan.id_kecamatan WHERE id_pelanggan='$_SESSION[id_pelanggan]'");
                                ...
                                <div class="col-md-8">
                                    ...
                                    <form method="POST">
										...
										<div class="form-group">
                                            ...
                                            <input class="form-control" name="alamat" value="<?php echo $data['kecamatan'];?>" />
                                            
                                        </div>

                                        <div class="form-group">
                                            <label>Alamat Lengekap</label>
...
<!--<td style="text-align: center;"><img src="gambar<?php echo $data['foto_profil'];?>" style="width: 120px;"></td> 