...
include('../koneksi.php');
    ...
    if(isset($_GET['id_pelanggan'])){
        ...
        $query = "SELECT * FROM pelanggan INNER JOIN kecamatan ON pelanggan.isi_kecamatan=kecamatan.id_kecamatan WHERE id_pelanggan='$id_pelanggan'";
	...
	<div class="wrapper">
		...
		<div class="main-panel">
			<div class="content">
				...
				<div class="mt-0 mb-4">
						<h2 class="text-white pb-2">Edit Profile</h2>
                        <div class="page-header">
						<h4 class="page-title active">Profile</h4>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <form method="POST" enctype="multipart/form-data" action="proses_edit.php">
										...
										<div class="form-group">
												...
												<select class="form-control" id="isi_kecamatan" name="isi_kecamatan" required>
													<option value="" disabled selected>Pilih kecamatan</option>
													<?php 
          											$sql1 = mysqli_query($koneksi, "SELECT * FROM kecamatan ORDER BY kecamatan ASC ");
          											while ($data1 = mysqli_fetch_array($sql1)){
            											echo '<option value="'.$data1['id_kecamatan'].'">'.$data1['kecamatan'].'</option>';
          										}
          										?>
												</select>
											</div>
        								...
        								<div class="form-group">
            								...
            								<br><img src="../profil/<?php echo $data['foto_profil'];?>" style="width:300px;">
            								<br><input type="file" name="foto_profil" />
