		...
		<div class="main-panel">
			<div class="content">
				<div class="page-inner">
					<div class="mt-2 mb-4">
						<h2 class="text-white pb-2">Menu Utama</h2>
					</div>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Favorit Produk</div>
								</div>
								<div class="card-body pb-0">
									<div class="d-flex">
										<div class="avatar avatar-xl">
											<img src="../assets/img/lele/lele-mentah.jpg" alt="..." class="avatar-img rounded-circle">
										</div>
										<div class="flex-1 pt-1 ml-2">
											<p></p>
											<h6 class="fw-bold mb-1">Lele Mentah</h6>
									...
									<div class="d-flex">
										<div class="avatar avatar-xl">
											<img src="../assets/img/lele/lele-goreng.jpg" alt="..." class="avatar-img rounded-circle">
										</div>
										<div class="flex-1 pt-1 ml-2">
											<p></p>
											<h6 class="fw-bold mb-1">Lele-goreng</h6>
