			...
			<div class="content">
				<div class="page-inner">
					<div class="mt-2 mb-4">
                        ...
                        <div class="movies_box text-center">
							<div class="movies_img">
								<a href="detailcoba.php?id_produk=<?php echo $data['id_produk']; ?>">
								<img src="../produk/<?php echo $data['foto_produk'];?>" width="70px" height="70px" ></a>
                            </div>
                            <div class="movies_text " >
								<a><strong><?= $data['nama_produk']?></strong>
                                <br><strong>Stok: <?= $data['stok']?></strong>
                                <br><strong>Harga: Rp <?= number_format($data['harga'])?></strong></a>
                            </div>
                            </a> 
                        </div>
                        <?php 
