		...
		<div class="main-panel">
			<div class="content">
				<div class="page-inner">
					<a href="tambah_metode.php" class="btn btn-primary" style="margin-bottom: 15px;">+Tambah Data</a>
					<div class="mt-0 mb-4">
						<h2 class="text-white pb-2">Data Metode</h2>
					</div>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
                                    	...
                                    	<?php
                                    		...
                                    		$sql = $koneksi->query ("SELECT * FROM metode_bayar");
                                    	...
                                    	<tr>
											...
											<td><img src="../../metode/<?php echo $data['gambar'];?>" width="120px" height="120px" ></td>
                                    		</td>
                                    	</tr>
