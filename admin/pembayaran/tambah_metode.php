		...
		<div class="main-panel">
			<div class="content">
				<div class="page-inner">
					<div >
						<h2 class="text-white pb-2">Tambah Metode</h2>
					</div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <form method="POST" enctype="multipart/form-data" action="proses_tambah.php">
										...
										<div class="form-group"> 
            								<label>Metode</label>
            								<input class="form-control" name="metode"  required="required">
            								<input type="hidden" name="id_metode" autofokus=""  />
        								</div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="atas_nama" />
