		...
		<div class="main-panel">
			<div class="content">
				<div class="page-inner">
					<div >
						<h2 class="text-white pb-2">Edit Produk</h2>
					</div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <form method="POST" enctype="multipart/form-data" action="proses_edit.php">
										...
										<div class="form-group"> 
            								...
            								<input class="form-control" name="nama_produk"  value="<?php echo $data['nama_produk'] ?>" required="required">
            								<input type="hidden" name="id_produk" autofokus=""  value="<?php echo $data['id_produk'] ?>"/>
        								</div>

										<div class="form-group">
                                            <label>Deskripsi</label>
                                            <input class="form-control" name="deskripsi" required="required" value="<?php echo $data['deskripsi'] ?>"/>
                                            
                                        </div>

                                        <div class="form-group">
                                            <label>Stok</label>
                                            <input type="number" class="form-control" name="stok" value="<?php echo $data['stok'];?>"  required="required">
        								...
        								<div class="form-group">
            								...
            								<br><img src="../../produk/<?php echo $data['foto_produk'];?>" style="width:120px;">
            								<br><input type="file" name="foto_produk" >
                                        ...
                                        <div class="col text-right">
											...
											<a href="produk.php"><button type="button" class="btn btn-danger btn-lg">Kembali</button></a>
                                        </div>
										<br>
