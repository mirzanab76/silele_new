								...
								<ul class="nav nav-collapse">
									<li>
										<a href="../produk/produk.php">
                                            <i class="fas fa-layer-group active"></i>
											<span">Produk</span>
										</a>
									</li>
									<li>
		...
		<div class="main-panel">
			<div class="content">
				<div class="page-inner">
					...
					<div class="mt-0 mb-4">
						<h2 class="text-white pb-2">Data Produk</h2>
					</div>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
                                    	...
                                    	<tr>
											...
											<td><img src="../../produk/<?php echo $data['foto_produk'];?>" width="70px" height="70px" ></td>
                                            <td>
                                    			<a href="edit_produk.php?id_produk=<?php echo $data['id_produk']; ?>" class="btn btn-secondary">EDIT</a>
