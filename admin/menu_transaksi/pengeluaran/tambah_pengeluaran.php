                                ...
                                <div class="col-md-8">
                                    ...
                                    <form method="POST"  action="proses_tambah.php">
										...
										<div class="form-group"> 
            								...
            								<input class="form-control" name="nama_pengeluaran"  required="required">
            								<input type="hidden" name="id_pengeluaran" autofokus=""  />
        								</div>

                                        <div class="form-group"> 
            								<label>Keterangan</label>
            								<input class="form-control" name="keterangan"  required="required">
        								</div>
