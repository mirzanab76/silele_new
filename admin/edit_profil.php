		...
		<div class="main-panel">
			<div class="content">
				<div class="page-inner">
					<div >
						<h2 class="text-white pb-2">edit profil</h2>
					</div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <form method="POST" enctype="multipart/form-data" action="proses_edit_profil.php">
                                        
										<div class="form-group"> 
            								<label>Nama</label>
            								<input class="form-control" name="nama"  value="<?php echo $data['nama'] ?>" required="required">
            								<input type="hidden" name="id_user" autofokus=""  value="<?php echo $data['id_user'] ?>" >
        								</div>

                                        <div class="form-group">
                                            <label>Username</label>
                                            <input class="form-control" name="username" value="<?php echo $data['username'];?>" required="required">
                                            
                                        </div>

                                        <div class="form-group">
                                            <label>Password</label>
                                            <input class="form-control" name="password" value="<?php echo $data['password'];?>" required="required">
