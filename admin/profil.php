...
<head>
	...
	<link rel="icon" href="../assets/img/silele.png" />
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                    	...
                                    	<?php
                                    		...
                                    		$sql = $koneksi->query ("SELECT * FROM user WHERE level='admin' ORDER BY id_user");
								...
								<div class="mb-4 row">
    								...
    								<div class="col-sm-3">
      									<input  type="text" class="form-control" value="<?php echo $data['password'];?>">
    								</div>	
											</div>	
    								...
    								<div class="col-sm-3">
      									<input r type="text" class="form-control" value="<?php echo $data['email'];?>">
    								</div>	
											</div>	
								<a href="edit_profil.php?id_user=<?php echo $data['id_user']; ?>" class="btn btn-secondary">EDIT</a>																																																<?php  } ?>	
				</div>
			</div>
